...
export const sections = [
  {
    ...
    speech: 'Кем ты станешь завтра? Мир профессий меняется быстрее, чем когда-либо. Прямо сейчас рождаются специальности, о которых никто не думал десять лет назад. Узнай, куда движется будущее — и займи своё место в нём.',
    image: IMG_HERO,
  ...
  },
  {
    ...
    speech: 'Мир меняется быстро. По данным исследователей, около шестидесяти пяти процентов детей, которые сегодня идут в школу, будут работать в профессиях, которых пока не существует. Важно не угадать правильный ответ — важно научиться задавать правильные вопросы, выбирать осознанно и адаптироваться к переменам.',
  ...
  },
  {
    ...
    speech: 'Профессии будущего. Инженер искусственного интеллекта создаёт нейросети, которые меняют всё вокруг. Биохакер исследует границы человеческого тела и здоровья. Урбанист будущего проектирует города, удобные для жизни. XR-дизайнер строит виртуальные и дополненные миры. Эко-стратег создаёт устойчивую зелёную экономику. А космический инженер делает космос доступным для каждого. Это не фантастика — это уже происходит.',
  ...
  },
  {
    ...
    speech: 'Выбор — это навык. Жизненный путь не прописан заранее и не достаётся по наследству. Его строят те, кто умеет останавливаться и слышать себя. Те, кто замечает, что происходит вокруг, и не боится пробовать новое. Каждое решение — это кирпичик. Каждая попытка — это опыт. И даже ошибка на пути — это шаг вперёд, а не назад.',
    image: IMG_GROWTH,
    imagePosition: 'right' as const,
  },
  {
    ...
    speech: 'Начни строить себя. Твоя профессия будущего уже существует — она ждёт тебя. Первый шаг — это решимость. Решимость исследовать, пробовать, ошибаться и двигаться дальше. Не жди идеального момента. Идеальный момент — это сейчас.',
    showButton: true,
